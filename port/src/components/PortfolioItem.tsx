...
const PortfolioItem: React.FC<IPortfolio> = ({ id, title, imgUrl, stack, link, text }: IPortfolio) => {
  return (
    <div data-testid="portfolio" className="border-2 border-stone-900 rounded-md overflow-hidden shadow-2xl max-w-sm" id={`timeline-item-${id}`}
>
      <img
        src={imgUrl}
        alt={`${title} project`}
